...
namespace InfoBarDemo
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Windows.UI.Xaml.Build.Tasks"," 10.0.19041.1")]
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        private class FavoritesPage_obj9_Bindings :
        ...
        {
            private global::InfoBarDemo.Models.FavoritesFiles dataRoot;
            ...
            public FavoritesPage_obj9_Bindings()
            {
            }

            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 88 && columnNumber == 73)
                {
                    isobj10SourceDisabled = true;
                }
                else if (lineNumber == 89 && columnNumber == 66)
                {
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::InfoBarDemo.Models.FavoritesFiles) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::InfoBarDemo.Models.FavoritesFiles)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::InfoBarDemo.Models.FavoritesFiles obj, int phase)
            {
                if (obj != null)
                {
        ...
        private class FavoritesPage_obj1_Bindings :
            ...
            IFavoritesPage_Bindings
        {
            private global::InfoBarDemo.FavoritesPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public void Connect(int connectionId, global::System.Object target)
            {
                switch(connectionId)
                {
                    case 7: // FavoritesPage.xaml line 84
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::InfoBarDemo.FavoritesPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::InfoBarDemo.FavoritesPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Favorites(global::System.Collections.Generic.List<global::InfoBarDemo.Models.FavoritesFiles> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // FavoritesPage.xaml line 84
        ...
        public void Connect(int connectionId, object target)
        {
            switch(connectionId)
            {
            case 2: // FavoritesPage.xaml line 13
                {
                    this.split = (global::Windows.UI.Xaml.Controls.SplitView)(target);
                }
                break;
            case 3: // FavoritesPage.xaml line 22
                {
        ...
        public global::Windows.UI.Xaml.Markup.IComponentConnector GetBindingConnector(int connectionId, object target)
        {
            ...
            switch(connectionId)
            {
            case 1: // FavoritesPage.xaml line 1
                {                    
            ...
            case 9: // FavoritesPage.xaml line 87
                {                    
                    ...
                    FavoritesPage_obj9_Bindings bindings = new FavoritesPage_obj9_Bindings();
                    returnValue = bindings;
